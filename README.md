...
- Each day is one mode: release year, age at release or Middle mode. The mode is selected deterministically by date so every puzzle stays internally consistent.
